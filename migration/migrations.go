...
var _bindata = map[string]func() (*asset, error){
	"migration/mysql/1.0.0_initial_schema.sql": migrationMysql100initialschemaSQL,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"migration": {nil, map[string]*bintree{
		"mysql": {nil, map[string]*bintree{
			"1.0.0_initial_schema.sql": {migrationMysql100initialschemaSQL, map[string]*bintree{}},
		}},
	}},
}}
